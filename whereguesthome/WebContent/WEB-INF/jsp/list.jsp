	...
	<body>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			...
			<!-- 判断是否是第一页 -->
				...
				<c:if test="${pagebean.pageNumber != 1 }">
					<li>
						 <a href="${pageContext.request.contextPath}/jsp/list?pageNumber=${pagebean.pageNumber-1}&gName=${param.gName}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:if>
				...
				<c:forEach begin="1" end="${pagebean.totalPage }" var = "n">
					...
					<c:if test="${pagebean.pageNumber != n }">
						<li><a href="${pageContext.request.contextPath }/jsp/list?gName=${param.gName}&pageNumber=${n}">${n }</a></li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pagebean.pageNumber != pagebean.totalPage }">
					<li>
						<a href="${pageContext.request.contextPath }/jsp/list?gName=${param.gName}&pageNumber=${pagebean.pageNumber+1}" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:if>
