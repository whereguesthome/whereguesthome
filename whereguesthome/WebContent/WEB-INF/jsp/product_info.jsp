...
<script type="text/javascript">
	$(function() {
		$("#formTest").submit(
				function() {
					$.post("${pageContext.request.contextPath}/jsp/addShopcar",
							$("#formTest").serialize(),
							function(msg) {
								alert(msg)
							})
	...
	<div class="container">
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					<div>
						<strong>${ goodsBygId.gName}</strong>
					</div>
					<div
					...
					<div style="margin: 10px 0 10px 0;">
						原价:
						<del>￥${ goodsBygId.gPrice}</del>
					</div>

					<div style="margin: 10px 0 10px 0;">
						促销: <strong style="color: #ef0101;">￥：${ goodsBygId.gSaleprice}</strong>
						限时抢购
					</div>
					...
					<div
						...
						<form id="formTest">
							<input type="hidden" name="g_id" value="${ goodsBygId.gId}">
							<input type="hidden" name="u_id" value="${user.uId }">
							<div
								style="border-bottom: 1px solid #faeac7; margin-top: 20px; padding-left: 10px;">
								购买数量: <input id="quantity" name="s_num" value="1" maxlength="4"
									size="10" type="text">
							</div>
